...
<body>				<!-- <c:url value="/register/save"/>는 ①context root 자동 추가 ②session id 자동 추가 -->
   <form action="/ch2/register/save" method="POST" onsubmit="return formCheck(this)">
    <div class="title">Register</div>
    <div id="msg" class="msg"> ${URLDecoder.decode(param.msg, "utf-8")} </div> 
    <label for="">아이디</label>															<!-- autofocus: 아이디에서 커서 깜박거림 -->
   ...
   <script>
       ...
       function setMessage(msg, element){												// ${msg}는 template literal임
