...
public class RequestParamTest {
	// 예외처리하는 부분임
	@ExceptionHandler(Exception.class) // 모든 예외처리의 조상인 Exception.class라서 모든 예외 다 잡음
...
//		http://localhost/ch2/requestParam3?year    ---->> year="" // String 값이어서 ""공백으로 나옴
		System.out.printf("[%s]year=[%s]%n", new Date(), year);
		return "yoil";	
	}

	@RequestMapping("/requestParam4")
	public String main4(@RequestParam(required=false) String year) { // required=false일때 RequestParam5처럼 기본값 줘야함
...
// =======================================================================
	...
	public String main6(int year) { // int값인데 ""공백으로 주면 400에러 뜬다는 내용
